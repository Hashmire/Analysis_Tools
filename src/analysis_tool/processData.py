...
from .nvd_source_manager import get_source_name, get_source_info, get_all_sources_for_cve
            ...
            for container in containers:
                ...
                if 'affected' in container:
                    for affected in container['affected']:
                        ...
                        # Enrich the affected data with source information
                        enriched_affected = affected.copy()
                        enriched_affected['sourceInfo'] = {
                            'sourceId': source_id,
