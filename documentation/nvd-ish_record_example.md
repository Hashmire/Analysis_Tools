...
```
Enhanced CVE Record Architecture
├── I. NVD 2.0 CVE Record Fields (Foundation)
└── II. Analysis_Tools Enhanced Structure
    ├── II.A. Tool Execution Metadata
    ├── II.B. CPE Suggestion Metadata (Large Dataset)
...
```python
{
    # === MANDATORY NVD 2.0 CVE RECORD FIELDS ===
    "id": "CVE-1337-99999",
...
```python
                ...
                "aliasExtraction": {
                    ...
                    # Alias sets that match established confirmed mappings
                    "confirmedMappings": [
                        {
                            "cpeBaseString": "cpe:2.3:a:example_vendor:example_product:*:*:*:*:*:*:*:*",
                            "aliases": [
                    ...
                    "aliasSets": [
                        {
                            "vendor": "example_vendor",
                            "product": "example_product", 
                            "platform": "windows"  # This combination not in confirmed mappings
                        },
                        {
                            "vendor": "example_vendor",
...
```python
                ...
                "cpeSuggestions": {
                    ...
                    # Heuristic suggestions generated by algorithm - maps to enrichedCVEv5Affected.cpeSuggestionMetadata
                    "heuristicSuggestions": [
                        "cpe:2.3:a:example_vendor:example_product:*:*:*:*:*:*:*:*",
                        "cpe:2.3:a:example_vendor:*:*:*:*:*:*:*:*:*", 
                        "cpe:2.3:*:example_vendor:example_product:*:*:*:*:*:*:*:*",
                        "cpe:2.3:a:*:example_product:*:*:*:*:*:*:*:*",
                        "cpe:2.3:a:example_vendor:example_product:4.2.1:*:*:*:*:*:*:*"
                    ],
                    
                    # CPE base strings that were generated but culled during validation
                    "cpeBaseStringsCulled": [
                        {
                            "cpeString": "cpe:2.3:a:*:*:*:*:*:*:*:*:*:*",
                            "reason": "overly_broad_query"
                        },
                        {
                            "cpeString": "cpe:2.3:a:e:*:*:*:*:*:*:*:*:*",
                            "reason": "insufficient_specificity"
                        },
                        {
                            "cpeString": "cpe:2.3:a:ab:*:*:*:*:*:*:*:*:*:*",
                            "reason": "insufficient_specificity"
                        },
                        {
                            "cpeString": "cpe:2.3:a:example_vendor:*:*:invalid_char@domain:*:*:*:*:*:*",
                            "reason": "nvd_api_incompatible"
                        },
                        {
                            "cpeString": "cpe:2.3:a:example_vendor_with_unicode_café:product:*:*:*:*:*:*:*:*",
                            "reason": "nvd_api_incompatible"
                        }
                    ]
                },
...
**II.A. Tool Execution Metadata (stored data):**
...
**II.B. CPE Suggestion Metadata (stored data):**
...
**II.C.3. Alias Extraction (stored data):**
- `confirmedMappings`: Known CPE base string mappings with alias arrays
- `aliasSets`: Unconfirmed alias groupings for curator review
- Processing functions: `find_confirmed_mappings()` in `processData.py`

**II.C.4. CPE Suggestions (stored data):**
- `confirmedMappings`: Validated CPE base strings from mapping files
- `heuristicSuggestions`: Algorithm-generated CPE suggestions
- `cpeBaseStringsCulled`: Rejected CPEs with validation failure reasons
- Processing functions: `find_confirmed_mappings()`, `deriveCPEMatchStringList()`, validation functions in `processData.py`

**II.C.5. CPE-AS Generation Rules (stored data):**
